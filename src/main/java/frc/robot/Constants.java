...
public final class Constants {
    ...
    // Climb
     // Left 
     public static int kClimbLeftHigherForwardID = 12;
     public static int kClimbLeftHigherReverseID = 13;
     public static int kClimbLeftLowerForwardID = 14;
     public static int kClimbLeftLowerReverseID = 15;
     // Right
     public static int kClimbRightHighForwardID = 16;
     public static int kClimbRightHighReverseID = 17;
     public static int kClimbRightLowForwardID = 18;
     public static int kClimbLeftLowReverseID = 19;
}